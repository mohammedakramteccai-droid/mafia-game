  ...
  ar: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'مراحل اللعبة',
        content: [
          { type: 'phase', icon: '🌙', title: 'مرحلة الليل', color: '#8d65ff', value: 'يغمض الجميع أعينهم. تستيقظ المافيا وتختار ضحية لقتلها. ثم يستيقظ المختار (المحقق) ويتحقق من هوية لاعب. ثم الطبيب يختار لاعباً لحمايته. إذا حمى الطبيب نفس الشخص الذي اختارته المافيا، لا يموت أحد!' },
          ...
          { type: 'text', value: 'تتكرر هذه المراحل (ليل ← نهار ← تصويت) حتى يفوز أحد الفريقين.' },
        ],
      },
      {
        id: 'cards',
        ...
        content: [
          ...
          { type: 'card', emoji: '💊', name: 'الطبيب', team: 'فريق المواطنين', teamColor: '#22d6b5', desc: 'كل ليلة يختار لاعباً لحمايته من القتل. إذا اختارت المافيا نفس الشخص الذي يحميه الطبيب، ينجو الضحية! لا يستطيع حماية نفسه (في بعض الإعدادات).' },
          ...
          { type: 'divider', label: 'بطاقات اختيارية (إضافية)' },
          { type: 'card', emoji: '🔫', name: 'المواطن القناص', team: 'فريق المواطنين', teamColor: '#ff8c00', desc: 'يختار هدفاً ليلاً لقتله. إذا كان الهدف مافيا، يموت الهدف فقط. لكن إذا كان الهدف مواطناً بريئاً، يموت كلاهما! سلاح ذو حدين يتطلب حكمة.' },
          { type: 'card', emoji: '🤐', name: 'القاتل الصامت', team: 'فريق المافيا', teamColor: '#7b2fff', desc: 'حليف المافيا. كل ليلة يختار لاعباً لإسكاته. اللاعب المُسكَت لا يستطيع التحدث خلال مرحلة النهار التالية، مما يمنعه من مشاركة معلوماته.' },
          { type: 'card', emoji: '👑', name: 'عمدة المواطنين', team: 'فريق المواطنين', teamColor: '#ffd60a', desc: 'يبدأ كمواطن عادي لكنه يملك قدرة خاصة: يمكنه كشف بطاقته في أي وقت خلال النهار. عند الكشف، يصبح صوته يساوي 3 أصوات في التصويت! لكن المافيا ستعرف هويته وقد تستهدفه.' },
          { type: 'card', emoji: '😇', name: 'الولد الصالح', team: 'فريق المواطنين', teamColor: '#90e0ef', desc: 'عندما يتم إخراجه من اللعبة (بالتصويت أو القتل)، يحق له اختيار لاعب آخر ليخرج معه! فرصة أخيرة للانتقام أو إنقاذ الفريق بإخراج مافيا مشتبه به.' },
        ],
      },
      {
        id: 'tips',
        ...
        content: [
          ...
          { type: 'tip', icon: '🎯', value: 'القناص سلاح خطير - لا تستخدمه إلا عندما تكون متأكداً من هوية المافيا.' },
        ],
      },
    ],
  },
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          { type: 'phase', icon: '🌙', title: 'Night Phase', color: '#8d65ff', value: 'Everyone closes their eyes. The Mafia wakes up and chooses a victim to kill. Then the Detective wakes up and investigates a player. Then the Doctor chooses someone to protect. If the Doctor protects the Mafia\'s target, nobody dies!' },
          ...
          { type: 'text', value: 'These phases repeat (Night → Day → Voting) until one team wins.' },
        ],
      },
      {
        id: 'cards',
        ...
        content: [
          ...
          { type: 'divider', label: 'Optional (Extra) Cards' },
          { type: 'card', emoji: '🔫', name: 'Vigilante', team: 'Citizens Team', teamColor: '#ff8c00', desc: 'Chooses a target at night to kill. If the target is Mafia, only the target dies. But if the target is an innocent citizen, both die! A double-edged sword requiring wisdom.' },
          { type: 'card', emoji: '🤐', name: 'Silencer', team: 'Mafia Team', teamColor: '#7b2fff', desc: 'Mafia ally. Each night, chooses a player to silence. The silenced player cannot speak during the next day phase, preventing them from sharing information.' },
          { type: 'card', emoji: '👑', name: 'Mayor', team: 'Citizens Team', teamColor: '#ffd60a', desc: 'Starts as a regular citizen but has a special power: can reveal their card at any time during the day. When revealed, their vote counts as 3 votes! But the Mafia will know their identity and may target them.' },
          { type: 'card', emoji: '😇', name: 'Good Boy', team: 'Citizens Team', teamColor: '#90e0ef', desc: 'When eliminated from the game (by vote or kill), they get to choose another player to take down with them! A last chance for revenge or saving the team by eliminating a suspected Mafia member.' },
        ],
      },
      {
        id: 'tips',
        ...
        content: [
          ...
          { type: 'tip', icon: '🎯', value: 'The Vigilante is dangerous — only use it when you\'re sure of the Mafia\'s identity.' },
        ],
      },
    ],
  },
